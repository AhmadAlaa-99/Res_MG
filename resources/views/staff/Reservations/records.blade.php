            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-block d-sm-flex border-0">
                        <div class="me-3">
                            <h4 class="card-title mb-2">Reservations Records</h4>
                            <span class="fs-12">Reservations</span>
                        </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="user-info">
                                                    <h6 class="fs-16 font-w700 mb-0"><a
                                                            href="javascript:void(0)">{{ $resturant->name }}</a></h6>
                                                    <span class="fs-14">{{ $resturant->phone_number }}</span>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
										...
										<form class="comment-form" method="post" action="{{ route('record_update') }}" autocomplete="off"
