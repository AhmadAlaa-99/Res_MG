                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex mb-3 border-bottom justify-content-between flex-wrap align-items-center">
                                <div class="d-flex pb-3 align-items-center">
                                    <img src="{{ URL::asset('dashboard/images/card/1.jpg') }}" alt="" class="rounded me-3 card-list-img" width="130">
                                    <div class="me-3">
                              ...
                              <td>
                                <div class="d-flex">
                                    <a href="{{route('tables.edit',$table->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                     ...
                                     <form id="destroy-form-{{ $table->id }}" action="{{ route('tables.destroy', $table->id) }}"
