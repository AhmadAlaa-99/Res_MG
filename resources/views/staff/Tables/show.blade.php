...
@endsection
@section('title')
    Restrants Management - Table Details
@stop
@section('content')
                        ...
                        <div class="">
                            <div id="external-events" class="my-3">
                                ...
                                <div class="external-event btn-primary light" data-class="bg-primary"><i
                                        class="fa fa-move"></i><span>Number : {{ $tab->number ?? '-' }}</span></div>

                                <div class="external-event btn-danger light" data-class="bg-danger"><i
                                        class="fa fa-move"></i>Configuration : {{ $tab->seating_configuration ?? '-' }}
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('date_tables', $tab->id) ?? '-' }}" autocomplete="off"
