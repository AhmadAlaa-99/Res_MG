...
@endsection
@section('title')
Restrants Management - Resturant Tables
@stop
@section('content')
    <!-- row -->
											...
											<table class="table table-bordered table-striped verticle-middle table-responsive-sm">
												...
												<tbody>
													...
													<tr>
														...
														<td><span class="badge badge-primary">{{$table->seating_configuration}}</span>
														</td>
														...
														<td><span>
															...
															<a href="{{route('table_reservations')}}" class="me-4" data-bs-toggle="tooltip" 
